...
hero:
  ...
  image:
    src: /img/logos/skargrid-icon.svg
    alt: SkarGrid
  actions:
    - theme: brand
      text: Começar
...
features:
  - title: Zero dependências
    details: Pure Vanilla JavaScript. Uma tag de script ou um import via npm — sem cadeia de dependências de runtime para auditar.
